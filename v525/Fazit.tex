...
$\overline{t}_\text{FWHM} = 16,3(1)\mu s.$
...
Die zugehörige Halbwertszeit beträgt: $t_{1/2} = (5,43\pm0,80)\,\mathrm{ns}$ ns, welcher um 13,6\% mit dem in der Literatur angegebenen Wert von $t_{1/2,\mathrm{lit}} = 6,283(14)\,\mathrm{ns}$ bei einer 1-$\sigma$-Umgebung) übereinstimmt.