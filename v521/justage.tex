...
Die drei radioaktiven Quellen werden nun vermessen. Die Aktivität, Messdauer und Detektorabstände bei der Messung sind in Tabelle \ref{tab_1} Abhängig von der Aktivität wurden die Dauer und Abstände angepasst, um immer eine zufriedenstellende Messrate zu erhalten.
\begin{table}[H]
\centering
\caption{Aktivitäten der verwendeten Quellen zum Messzeitpunkt. 
Der Abstand zwischen Quelle und Detektor betrug stets $10 \pm 2\,\mathrm{cm}$. (am 15.06.2026)}
\begin{table}[H]
\centering
\caption{Verwendete Kalibrationsquellen mit Halbwertszeiten, Anfangsaktivitäten, zum Messzeitpunkt berechneten Aktivitäten und den verwendeten Abständen zur Detektorfront(Links für NaI und rechts für HPGe. Die Aktivitäten beziehen sich auf den 15.06.2026.}
\label{tab:quellen}
\begin{tabular}{lcccc}
\hline
Isotop & $T_{1/2}$ & $A_0$ / Bq & $A(15.06.2026)$ / Bq & Abstand / cm \\
\hline
\textsuperscript{137}Cs & 30.05 a & $A_{0,\mathrm{Cs}}$ & $363\,398$ & 10.0(2) \\

\textsuperscript{60}Co & 5.27 a & $A_{0,\mathrm{Co}}$ & $36\,112$ & 1.0/10.0(2) \\

\textsuperscript{152}Eu & 13.52 a & $A_{0,\mathrm{Eu}}$ & $557\,050$ & 20.0/10.0(2) \\
\hline
\end{tabular}
\end{table}
