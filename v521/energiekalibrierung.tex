...
kinetische Energie des Photoelektrons überführt:
...
\subsubsection*{5.1.x \,$\gamma$-Spektrum von $^{137}$Cs}
...
unterdrücken, sodass der Photopeak klar isoliert werden kann.
\subsubsection*{5.1.x \,$\gamma$-Spektrum von $^{60}$Co}
...
annähern, ohne jedoch zu überlappen.
...
\begin{table}[H]
\centering
\caption{Literaturwerte der $\gamma$-Energien und relativen Intensitäten von $^{152}$Eu}
\begin{tabular}{c c}
\hline
