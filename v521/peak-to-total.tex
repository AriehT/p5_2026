...
Für $E_\gamma(Co)=1250 keV$\\
HPGe:
\[
P_T(\text{Cs}) = (18,42\pm0,07)\%, \qquad P_T(\text{Co}) = (11,25\pm0,017)\%
\]

NaI:
\[
P_T(\text{Cs}) = (33,39\pm1,04)\%, \qquad P_T(\text{Co}) = (22,60\pm0,17)\%
\tag{7}
\]
