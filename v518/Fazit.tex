...
\begin{align*}
    \chi^2_{\text{red}}=1,35
\end{align*}
besser als bei der Gauß-Verteilung mit dem Wert $\chi^2_{\text{red}}=3,13$. Dies bestätigt, dass die Landauverteilung ein passendes Modell für die experimentellen Werte ist und entspricht der Erwartung für dünne Szintillatoren, bei denen das Pulshöhenspektrum durch eine Landau-Verteilung beschrieben wird.

Im zweiten Teil des Versuchs wird die Lebensdauer der Myonen bestimmt. Der erhaltene Wert
$\tau = (\num{0.631} \pm \num{0.001})\,\si{\micro\second}$ \\
Dieser Wert liegt deutlich unter dem Literaturwert von \(\tau = \SI{2.1969811(22)}{\micro\second}\) und passt nicht mit diesem innerhalb einer $3\sigma$-Umgebung überrein.
