...
Bevor die Messung durchgeführt werden konnte, mussten die FPGAs entsprechend konfiguriert werden. Dies erfolgte mittels LabVIEW; der für die erste Messung verwendete grafische Programmcode ist in Abbildung \ref{fig:labview_short} dargestellt.
\begin{figure}[H]
    \centering
    \includegraphics[width=0.48\textwidth]{figs/}
    \caption{}
    \label{fig:labview_short}
\end{figure}
