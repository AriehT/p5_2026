...
\begin{figure}[H]
    ...
    \begin{subfigure}[t]{0.48\textwidth}%bild photokathode
        ...
        \caption{Aufbau eines Photomultipliers \cite{Grupen_1}. Das Elektrodensystem ist in einer evakuierten Glasröhre montiert. Der Photomultiplier wird üblicherweise durch einen Mu-Metall-Zylinder aus hochpermeablem Material gegen magnetische Streufelder abgeschirmt.}
    \end{subfigure}
